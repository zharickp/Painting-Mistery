...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-400 mt-1">Historial de tus compras en Painting Mistery.</p>
</div>
@php $ventas = auth()->user()->ventas()->orderByDesc('fecha')->paginate(10); @endphp
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-5 py-3 font-mono text-gray-400">#{{ str_pad($v->id, 4, '0', STR_PAD_LEFT) }}</td>
                    <td class="px-5 py-3 text-gray-600">{{ \Carbon\Carbon::parse($v->fecha)->format('d/m/Y H:i') }}</td>
                ...
                @empty
                <tr><td colspan="4" class="px-5 py-12 text-center text-gray-400">Aún no has realizado ningún pedido.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
