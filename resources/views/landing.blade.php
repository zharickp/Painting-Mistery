...
<div class="bg-white">
    ...
    @if ($banners->isEmpty())
        ...
        <div class="h-[45vh] sm:h-[55vh] md:h-[60vh] max-h-[560px] overflow-hidden">
    ...
    @else
        ...
        <div id="heroSlider" class="relative overflow-hidden bg-gray-900 h-[45vh] sm:h-[55vh] md:h-[60vh] max-h-[560px]">
