...
{{-- ═══════════════ PANEL CARRITO (slide-in derecho) ═══════════════ --}}
<div id="carritoModal" class="hidden fixed inset-0 z-50">
    <div class="absolute inset-0 bg-black/50" onclick="cerrarCarrito()"></div>
    <div id="carritoPanel"
         class="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-2xl flex flex-col transform translate-x-full transition-transform duration-300 ease-out">
        ...
        <div id="carritoFooter" class="hidden border-t border-gray-100 px-6 py-4 space-y-3 bg-gray-50/60">
            ...
            @auth
                <button type="button" onclick="irACheckout(this)"
                   class="flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 disabled:opacity-60 text-white font-bold py-3 rounded-xl text-sm transition w-full shadow-md shadow-red-900/20">
            ...
            <a id="carritoWaBtn" href="#" target="_blank"
               class="flex items-center justify-center gap-2 border border-green-500 text-green-600 hover:bg-green-50 font-semibold py-2.5 rounded-xl text-sm transition w-full">
